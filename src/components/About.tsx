    ...
    <section id="about" className="py-24 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4 text-gray-600 leading-relaxed text-lg">
          <p>
            I&apos;m a freshman at <span className="text-gray-900 font-medium">UCLA</span> studying{" "}
            <span className="text-gray-900 font-medium">Mathematics of Computation</span>, blending
          ...
          <p>
            ...
            at <span className="text-gray-900 font-medium">Yale&apos;s Townsend Lab</span>, and co-authored
            econometric studies at the{" "}
            <span className="text-gray-900 font-medium">Fudan-Stanford Institute</span>. On the
