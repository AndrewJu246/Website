  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-6 pt-16">
      <div className="max-w-2xl text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-5 animate-fade-in-up animation-delay-300">
          <a
        ...
        <div className="mt-12">
          <a
            href="#about"
            className="inline-flex items-center text-sm text-gray-400 hover:text-gray-600 transition-colors animate-bounce"
          >
